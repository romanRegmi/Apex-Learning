...
// Or when something is clicked. (Done using LWC not this)
...
public with sharing class PublishPlatformEvent {
    ...
    PublishPlatformEventCallback callbackInstance = new PublishPlatformEventCallback(); // This is used for monitoring if the platform event published successfully.
